...
const getAllBuyer = (params, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_2.default.buyer.findMany({
    ...
    const total = yield prisma_2.default.buyer.count({ where: whereConditions });
    return {
        meta: {
            page,
            limit,
...
const getSingleBuyerFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_2.default.buyer.findUnique({
        where: {
            id,
        },
        include: {
...
const updateBuyerDataFromDB = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    yield prisma_2.default.buyer.findUniqueOrThrow({
        where: { id },
    });
    const result = yield prisma_2.default.buyer.update({
        where: {
            id,
        },
        data,
...
const deleteBuyerFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_2.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const buyerDeleteData = yield transactionClient.buyer.delete({
            where: { id },
        });
...
const softDeleteBuyerFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_2.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        // Deleting the buyer record
        const buyerDeleteData = yield transactionClient.buyer.update({
            where: { id },
            data: { isDeleted: true },
        });
        yield transactionClient.user.update({
            where: { email: buyerDeleteData.email },
            data: { status: prisma_1.UserStatus.DELETED },
        });
        return buyerDeleteData;
    }));
    return result;
